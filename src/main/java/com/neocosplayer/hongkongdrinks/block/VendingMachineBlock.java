...
package com.neocosplayer.hongkongdrinks.block;
...
import com.neocosplayer.hongkongdrinks.procedures.VendingMachineOnBlockRightClickedProcedure;
import com.neocosplayer.hongkongdrinks.itemgroup.HongKongDrinksItemGroup;
import com.neocosplayer.hongkongdrinks.gui.VendingMachineGUIGui;
import com.neocosplayer.hongkongdrinks.HongkongdrinksModElements;

@HongkongdrinksModElements.ModElement.Tag
public class VendingMachineBlock extends HongkongdrinksModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new BlockItem(block, new Item.Properties().group(HongKongDrinksItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(VendingMachineBlock.block, (int) (1)));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new VendingMachineGUIGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new VendingMachineGUIGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
