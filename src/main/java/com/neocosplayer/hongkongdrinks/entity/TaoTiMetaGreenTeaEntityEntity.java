...
import com.neocosplayer.hongkongdrinks.procedures.TaoTiMetaGreenTeaEntityEntityIsHurtProcedure;
...
public class TaoTiMetaGreenTeaEntityEntity extends HongkongdrinksModElements.ModElement {
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(TaoTiMetaGreenTeaItem.block, (int) (1)));
		}
