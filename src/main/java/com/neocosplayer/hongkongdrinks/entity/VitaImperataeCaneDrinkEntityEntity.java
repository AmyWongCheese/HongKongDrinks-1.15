...
import com.neocosplayer.hongkongdrinks.procedures.VitaImperataeCaneDrinkEntityEntityIsHurtProcedure;
...
public class VitaImperataeCaneDrinkEntityEntity extends HongkongdrinksModElements.ModElement {
	public static EntityType entity = null;
	public VitaImperataeCaneDrinkEntityEntity(HongkongdrinksModElements instance) {
		super(instance, 132);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.2f, 0.5f))
						.build("vita_imperatae_cane_drink_entity").setRegistryName("vita_imperatae_cane_drink_entity");
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelvitalemontea1(), 0.05f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("hongkongdrinks:textures/vitaimperatae_e.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				VitaImperataeCaneDrinkEntityEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
