...
import com.neocosplayer.hongkongdrinks.procedures.VitaLycheeLoveTeaEntityEntityIsHurtProcedure;
...
public class VitaLycheeLoveTeaEntityEntity extends HongkongdrinksModElements.ModElement {
	public static EntityType entity = null;
	public VitaLycheeLoveTeaEntityEntity(HongkongdrinksModElements instance) {
		super(instance, 277);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.2f, 0.5f))
						.build("vita_lychee_love_tea_entity").setRegistryName("vita_lychee_love_tea_entity");
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelvitabottle(), 0.05f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("hongkongdrinks:textures/vitalycheelovetea_e.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(VitaLycheeLoveTeaItem.block, (int) (1)));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				VitaLycheeLoveTeaEntityEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
