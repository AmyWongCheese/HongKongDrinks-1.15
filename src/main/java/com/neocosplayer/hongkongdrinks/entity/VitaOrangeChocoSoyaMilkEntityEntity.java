...
import com.neocosplayer.hongkongdrinks.procedures.VitaOrangeChocoSoyaMilkEntityEntityIsHurtProcedure;
...
public class VitaOrangeChocoSoyaMilkEntityEntity extends HongkongdrinksModElements.ModElement {
	public static EntityType entity = null;
	public VitaOrangeChocoSoyaMilkEntityEntity(HongkongdrinksModElements instance) {
		super(instance, 270);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.2f, 0.5f))
						.build("vita_orange_choco_soya_milk_entity").setRegistryName("vita_orange_choco_soya_milk_entity");
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelvitalemontea(), 0.05f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("hongkongdrinks:textures/vitaorangechocosoya_e.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(VitaOrangeChocoSoyaMilkItem.block, (int) (1)));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				VitaOrangeChocoSoyaMilkEntityEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
