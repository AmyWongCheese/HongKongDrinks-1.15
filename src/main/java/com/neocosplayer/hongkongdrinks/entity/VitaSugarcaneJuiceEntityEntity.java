...
import com.neocosplayer.hongkongdrinks.procedures.VitaSugarcaneJuiceEntityEntityIsHurtProcedure;
...
public class VitaSugarcaneJuiceEntityEntity extends HongkongdrinksModElements.ModElement {
	public static EntityType entity = null;
	public VitaSugarcaneJuiceEntityEntity(HongkongdrinksModElements instance) {
		super(instance, 213);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.2f, 0.5f))
						.build("vita_sugarcane_juice_entity").setRegistryName("vita_sugarcane_juice_entity");
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelvitalemontea1(), 0.05f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("hongkongdrinks:textures/vitasugarcane_e.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(VitaSugarcaneJuiceItem.block, (int) (1)));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				VitaSugarcaneJuiceEntityEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
