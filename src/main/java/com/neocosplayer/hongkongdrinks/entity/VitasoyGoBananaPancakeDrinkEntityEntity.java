...
import com.neocosplayer.hongkongdrinks.procedures.VitasoyGoBananaPancakeDrinkEntityEntityIsHurtProcedure;
...
public class VitasoyGoBananaPancakeDrinkEntityEntity extends HongkongdrinksModElements.ModElement {
	public static EntityType entity = null;
	public VitasoyGoBananaPancakeDrinkEntityEntity(HongkongdrinksModElements instance) {
		super(instance, 258);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.2f, 0.5f))
						.build("vitasoy_go_banana_pancake_drink_entity").setRegistryName("vitasoy_go_banana_pancake_drink_entity");
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelvitalemontea(), 0.05f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("hongkongdrinks:textures/vitabananapancake_e.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(VitasoyGoBananaPancakeDrinkItem.block, (int) (1)));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				VitasoyGoBananaPancakeDrinkEntityEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
