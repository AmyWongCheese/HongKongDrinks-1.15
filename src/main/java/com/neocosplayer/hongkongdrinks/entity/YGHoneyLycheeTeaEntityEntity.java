...
import com.neocosplayer.hongkongdrinks.procedures.YGHoneyLycheeTeaEntityEntityIsHurtProcedure;
import com.neocosplayer.hongkongdrinks.item.YGHoneyLycheeTeaItem;
import com.neocosplayer.hongkongdrinks.HongkongdrinksModElements;

@HongkongdrinksModElements.ModElement.Tag
public class YGHoneyLycheeTeaEntityEntity extends HongkongdrinksModElements.ModElement {
	public static EntityType entity = null;
	public YGHoneyLycheeTeaEntityEntity(HongkongdrinksModElements instance) {
		super(instance, 242);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.2f, 0.5f))
						.build("yg_honey_lychee_tea_entity").setRegistryName("yg_honey_lychee_tea_entity");
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.05f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("hongkongdrinks:textures/yglycheetea_e.png");
				}
			};
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(YGHoneyLycheeTeaItem.block, (int) (1)));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				YGHoneyLycheeTeaEntityEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
