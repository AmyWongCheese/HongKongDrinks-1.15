...
import com.neocosplayer.hongkongdrinks.procedures.YGMangoJuiceEntityEntityIsHurtProcedure;
...
public class YGMangoJuiceEntityEntity extends HongkongdrinksModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.2f, 0.5f))
						.build("yg_mango_juice_entity").setRegistryName("yg_mango_juice_entity");
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelvitalemontea1(), 0.05f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("hongkongdrinks:textures/ygmango_e.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(YGMangoJuiceItem.block, (int) (1)));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				YGMangoJuiceEntityEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
