...
import com.neocosplayer.hongkongdrinks.procedures.VitaImperataeCaneDrinkOnFoodRightClickedProcedure;
import com.neocosplayer.hongkongdrinks.itemgroup.HongKongDrinksItemGroup;
import com.neocosplayer.hongkongdrinks.HongkongdrinksModElements;

@HongkongdrinksModElements.ModElement.Tag
public class VitaImperataeCaneDrinkItem extends HongkongdrinksModElements.ModElement {
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("vita_imperatae_cane_drink");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.getPosZ();
			{
				...
				VitaImperataeCaneDrinkOnFoodRightClickedProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
