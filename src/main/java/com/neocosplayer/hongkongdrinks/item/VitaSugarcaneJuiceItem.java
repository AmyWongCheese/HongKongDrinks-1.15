...
import com.neocosplayer.hongkongdrinks.procedures.VitaSugarcaneJuiceOnFoodRightClickedProcedure;
...
public class VitaSugarcaneJuiceItem extends HongkongdrinksModElements.ModElement {
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("vita_sugarcane_juice");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			int z = (int) entity.getPosZ();
			{
				...
				VitaSugarcaneJuiceOnFoodRightClickedProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
