...
import com.neocosplayer.hongkongdrinks.procedures.YGPeachTeaOnFoodRightClickedProcedure;
	...
	public static class FoodItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.getPosZ();
			{
				...
				YGPeachTeaOnFoodRightClickedProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
