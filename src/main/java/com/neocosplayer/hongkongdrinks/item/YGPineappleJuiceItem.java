...
import com.neocosplayer.hongkongdrinks.procedures.YGPineappleJuiceOnFoodRightClickedProcedure;
...
public class YGPineappleJuiceItem extends HongkongdrinksModElements.ModElement {
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("yg_pineapple_juice");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			int z = (int) entity.getPosZ();
			{
				...
				YGPineappleJuiceOnFoodRightClickedProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
