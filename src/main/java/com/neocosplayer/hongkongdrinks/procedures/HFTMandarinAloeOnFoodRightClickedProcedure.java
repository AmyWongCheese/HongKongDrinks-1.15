...
import com.neocosplayer.hongkongdrinks.entity.HFTMandarinAloeEntityEntity;
import com.neocosplayer.hongkongdrinks.HongkongdrinksModElements;

@HongkongdrinksModElements.ModElement.Tag
public class HFTMandarinAloeOnFoodRightClickedProcedure extends HongkongdrinksModElements.ModElement {
	public HFTMandarinAloeOnFoodRightClickedProcedure(HongkongdrinksModElements instance) {
		super(instance, 240);
	}
		...
		if ((((entity.isSneaking()) && (new ItemStack(HFTMandarinAloeItem.block, (int) (1))
			...
			if (entity instanceof PlayerEntity)
				((PlayerEntity) entity).inventory
						.clearMatchingItems(p -> new ItemStack(HFTMandarinAloeItem.block, (int) (1)).getItem() == p.getItem(), (int) 1);
			...
			if (world instanceof World && !world.getWorld().isRemote) {
				Entity entityToSpawn = new HFTMandarinAloeEntityEntity.CustomEntity(HFTMandarinAloeEntityEntity.entity, world.getWorld());
				entityToSpawn
