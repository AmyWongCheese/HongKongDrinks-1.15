...
import com.neocosplayer.hongkongdrinks.entity.HFTSaltedMandarinEntityEntity;
...
public class HFTSaltedMandarinOnFoodRightClickedProcedure extends HongkongdrinksModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure HFTSaltedMandarinOnFoodRightClicked!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure HFTSaltedMandarinOnFoodRightClicked!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure HFTSaltedMandarinOnFoodRightClicked!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure HFTSaltedMandarinOnFoodRightClicked!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure HFTSaltedMandarinOnFoodRightClicked!");
			return;
		}
		...
		if ((((entity.isSneaking()) && (new ItemStack(HFTSaltedMandarinItem.block, (int) (1))
			...
			if (entity instanceof PlayerEntity)
				((PlayerEntity) entity).inventory
						.clearMatchingItems(p -> new ItemStack(HFTSaltedMandarinItem.block, (int) (1)).getItem() == p.getItem(), (int) 1);
			...
			if (world instanceof World && !world.getWorld().isRemote) {
				Entity entityToSpawn = new HFTSaltedMandarinEntityEntity.CustomEntity(HFTSaltedMandarinEntityEntity.entity, world.getWorld());
				entityToSpawn
