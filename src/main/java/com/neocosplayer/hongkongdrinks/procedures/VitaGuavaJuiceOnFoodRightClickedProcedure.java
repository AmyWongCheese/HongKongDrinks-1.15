...
import com.neocosplayer.hongkongdrinks.entity.VitaGuavaJuiceEntityEntity;
import com.neocosplayer.hongkongdrinks.HongkongdrinksModElements;

@HongkongdrinksModElements.ModElement.Tag
public class VitaGuavaJuiceOnFoodRightClickedProcedure extends HongkongdrinksModElements.ModElement {
	public VitaGuavaJuiceOnFoodRightClickedProcedure(HongkongdrinksModElements instance) {
		super(instance, 130);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((entity.isSneaking()) && (new ItemStack(VitaGuavaJuiceItem.block, (int) (1))
				.getItem() == ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem()))
				|| ((new ItemStack(VitaGuavaJuiceItem.block, (int) (1))
			...
			if (entity instanceof PlayerEntity)
				((PlayerEntity) entity).inventory.clearMatchingItems(p -> new ItemStack(VitaGuavaJuiceItem.block, (int) (1)).getItem() == p.getItem(),
						(int) 1);
			...
			if (((entity.getHorizontalFacing()) == Direction.NORTH)) {
				if (world instanceof World && !world.getWorld().isRemote) {
					Entity entityToSpawn = new VitaGuavaJuiceEntityEntity.CustomEntity(VitaGuavaJuiceEntityEntity.entity, world.getWorld());
