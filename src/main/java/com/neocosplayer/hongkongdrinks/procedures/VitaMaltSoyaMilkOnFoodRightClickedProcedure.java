...
import com.neocosplayer.hongkongdrinks.entity.VitaMaltSoyaMilkEntityEntity;
		...
		if ((((entity.isSneaking()) && (new ItemStack(VitaMaltSoyaMilkItem.block, (int) (1))
			...
			if (((entity.getHorizontalFacing()) == Direction.NORTH)) {
				if (world instanceof World && !world.getWorld().isRemote) {
					Entity entityToSpawn = new VitaMaltSoyaMilkEntityEntity.CustomEntity(VitaMaltSoyaMilkEntityEntity.entity, world.getWorld());
