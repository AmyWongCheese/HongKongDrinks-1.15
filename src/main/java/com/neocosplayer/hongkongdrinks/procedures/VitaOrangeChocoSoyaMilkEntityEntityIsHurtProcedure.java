...
public class VitaOrangeChocoSoyaMilkEntityEntityIsHurtProcedure extends HongkongdrinksModElements.ModElement {
	public VitaOrangeChocoSoyaMilkEntityEntityIsHurtProcedure(HongkongdrinksModElements instance) {
		super(instance, 270);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((!(new Object() {
			...
			if (!world.getWorld().isRemote) {
				ItemEntity entityToSpawn = new ItemEntity(world.getWorld(), x, y, z, new ItemStack(VitaOrangeChocoSoyaMilkItem.block, (int) (1)));
