...
public class VitaRedBeanSoyaMilkEntityEntityIsHurtProcedure extends HongkongdrinksModElements.ModElement {
	public VitaRedBeanSoyaMilkEntityEntityIsHurtProcedure(HongkongdrinksModElements instance) {
		super(instance, 278);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((!(new Object() {
			...
			if (!world.getWorld().isRemote) {
				ItemEntity entityToSpawn = new ItemEntity(world.getWorld(), x, y, z, new ItemStack(VitaRedBeanSoyaMilkItem.block, (int) (1)));
