...
public class VitaTiramisuDrinkGirlEntityEntityIsHurtProcedure extends HongkongdrinksModElements.ModElement {
	public VitaTiramisuDrinkGirlEntityEntityIsHurtProcedure(HongkongdrinksModElements instance) {
		super(instance, 289);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((!(new Object() {
			...
			if (!world.getWorld().isRemote) {
				ItemEntity entityToSpawn = new ItemEntity(world.getWorld(), x, y, z, new ItemStack(VitaTiramisuDrinkGirlItem.block, (int) (1)));
