...
import com.neocosplayer.hongkongdrinks.entity.YGPeachTeaEntityEntity;
import com.neocosplayer.hongkongdrinks.HongkongdrinksModElements;

@HongkongdrinksModElements.ModElement.Tag
public class YGPeachTeaOnFoodRightClickedProcedure extends HongkongdrinksModElements.ModElement {
	public YGPeachTeaOnFoodRightClickedProcedure(HongkongdrinksModElements instance) {
		super(instance, 178);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((entity.isSneaking()) && (new ItemStack(YGPeachTeaItem.block, (int) (1))
			...
			if (entity instanceof PlayerEntity)
				((PlayerEntity) entity).inventory.clearMatchingItems(p -> new ItemStack(YGPeachTeaItem.block, (int) (1)).getItem() == p.getItem(),
						(int) 1);
			...
			if (((entity.getHorizontalFacing()) == Direction.NORTH)) {
				if (world instanceof World && !world.getWorld().isRemote) {
					Entity entityToSpawn = new YGPeachTeaEntityEntity.CustomEntity(YGPeachTeaEntityEntity.entity, world.getWorld());
