...
public class HongkongdrinksModElements {
	...
	public HongkongdrinksModElements() {
		try {
			ModFileScanData modFileInfo = ModList.get().getModFileById("hongkongdrinks").getFile().getScanResult();
			Set<ModFileScanData.AnnotationData> annotations = modFileInfo.getAnnotations();
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					Class<?> clazz = Class.forName(annotationData.getClassType().getClassName());
					if (clazz.getSuperclass() == HongkongdrinksModElements.ModElement.class)
						elements.add((HongkongdrinksModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		HongkongdrinksMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final HongkongdrinksModElements elements;
		protected final int sortid;
		public ModElement(HongkongdrinksModElements elements, int sortid) {
