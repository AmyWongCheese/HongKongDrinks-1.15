...
import net.mcreator.hongkongdrinks.procedures.TaoTiGrapeJuiceEntityEntityIsHurtProcedure;
import net.mcreator.hongkongdrinks.item.TaoTiGrapeJuiceItem;
...
public class TaoTiGrapeJuiceEntityEntity extends HongkongdrinksModElements.ModElement {
	public static EntityType entity = null;
	public TaoTiGrapeJuiceEntityEntity(HongkongdrinksModElements instance) {
		super(instance, 93);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.2f, 0.5f))
						.build("tao_ti_grape_juice_entity").setRegistryName("tao_ti_grape_juice_entity");
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(TaoTiGrapeJuiceItem.block, (int) (1)));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				TaoTiGrapeJuiceEntityEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
