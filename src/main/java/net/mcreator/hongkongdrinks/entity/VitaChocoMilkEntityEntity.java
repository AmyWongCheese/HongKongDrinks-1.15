...
import net.mcreator.hongkongdrinks.procedures.VitaChocoMilkEntityEntityIsHurtProcedure;
...
public class VitaChocoMilkEntityEntity extends HongkongdrinksModElements.ModElement {
	public static EntityType entity = null;
	public VitaChocoMilkEntityEntity(HongkongdrinksModElements instance) {
		super(instance, 98);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.2f, 0.5f))
						.build("vita_choco_milk_entity").setRegistryName("vita_choco_milk_entity");
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelvitalemontea1(), 0.05f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("hongkongdrinks:textures/vitachoco.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(VitaChocolateMilkItem.block, (int) (1)));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				VitaChocoMilkEntityEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
