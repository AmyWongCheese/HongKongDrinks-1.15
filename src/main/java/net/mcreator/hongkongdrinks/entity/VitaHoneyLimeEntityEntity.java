...
import net.mcreator.hongkongdrinks.procedures.VitaHoneyLimeEntityEntityIsHurtProcedure;
import net.mcreator.hongkongdrinks.item.VitaHoneyLimeDrinkItem;
...
public class VitaHoneyLimeEntityEntity extends HongkongdrinksModElements.ModElement {
	public static EntityType entity = null;
	public VitaHoneyLimeEntityEntity(HongkongdrinksModElements instance) {
		super(instance, 38);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.2f, 0.5f))
						.build("vita_honey_lime_entity").setRegistryName("vita_honey_lime_entity");
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(VitaHoneyLimeDrinkItem.block, (int) (1)));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				VitaHoneyLimeEntityEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
