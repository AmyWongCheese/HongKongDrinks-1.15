...
import net.mcreator.hongkongdrinks.procedures.YGMandarinTeaOnFoodRightClickedProcedure;
...
public class YGMandarinTeaItem extends HongkongdrinksModElements.ModElement {
	@ObjectHolder("hongkongdrinks:yg_mandarin_tea")
	public static final Item block = null;
	public YGMandarinTeaItem(HongkongdrinksModElements instance) {
		super(instance, 15);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("yg_mandarin_tea");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			int z = (int) entity.getPosZ();
			{
				...
				YGMandarinTeaOnFoodRightClickedProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
