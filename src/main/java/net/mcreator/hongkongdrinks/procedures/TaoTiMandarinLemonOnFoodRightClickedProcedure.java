...
import net.mcreator.hongkongdrinks.entity.TaoTiMandarinLemonEntityEntity;
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((entity.isSneaking()) && (new ItemStack(TaoTiMandarinLemonItem.block, (int) (1))
			...
			if (((entity.getHorizontalFacing()) == Direction.NORTH)) {
				if (!world.isRemote) {
					Entity entityToSpawn = new TaoTiMandarinLemonEntityEntity.CustomEntity(TaoTiMandarinLemonEntityEntity.entity, world);
