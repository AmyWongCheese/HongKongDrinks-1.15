...
import net.mcreator.hongkongdrinks.item.TaoTiOolongTeaItem;
import net.mcreator.hongkongdrinks.entity.TaoTiOolongTeaEntityEntity;
import net.mcreator.hongkongdrinks.HongkongdrinksModElements;

@HongkongdrinksModElements.ModElement.Tag
public class TaoTiOolongTeaOnFoodRightClickedProcedure extends HongkongdrinksModElements.ModElement {
	public TaoTiOolongTeaOnFoodRightClickedProcedure(HongkongdrinksModElements instance) {
		super(instance, 85);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((entity.isSneaking()) && (new ItemStack(TaoTiOolongTeaItem.block, (int) (1))
				.getItem() == ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem()))
				|| ((new ItemStack(TaoTiOolongTeaItem.block, (int) (1))
			...
			if (entity instanceof PlayerEntity)
				((PlayerEntity) entity).inventory.clearMatchingItems(p -> new ItemStack(TaoTiOolongTeaItem.block, (int) (1)).getItem() == p.getItem(),
						(int) 1);
			...
			if (((entity.getHorizontalFacing()) == Direction.NORTH)) {
				if (!world.isRemote) {
					Entity entityToSpawn = new TaoTiOolongTeaEntityEntity.CustomEntity(TaoTiOolongTeaEntityEntity.entity, world);
