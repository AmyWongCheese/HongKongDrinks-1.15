...
import net.mcreator.hongkongdrinks.entity.VitaHoneyLimeEntityEntity;
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((entity.isSneaking()) && (new ItemStack(VitaHoneyLimeDrinkItem.block, (int) (1))
			...
			if (((entity.getHorizontalFacing()) == Direction.NORTH)) {
				if (!world.isRemote) {
					Entity entityToSpawn = new VitaHoneyLimeEntityEntity.CustomEntity(VitaHoneyLimeEntityEntity.entity, world);
