...
import net.mcreator.hongkongdrinks.item.VitaSoyaMilkItem;
import net.mcreator.hongkongdrinks.entity.VitaSoyaMilkEntityEntity;
...
public class VitaSoyaMilkOnFoodRightClickedProcedure extends HongkongdrinksModElements.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure VitaSoyaMilkOnFoodRightClicked!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure VitaSoyaMilkOnFoodRightClicked!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure VitaSoyaMilkOnFoodRightClicked!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure VitaSoyaMilkOnFoodRightClicked!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure VitaSoyaMilkOnFoodRightClicked!");
			return;
		}
