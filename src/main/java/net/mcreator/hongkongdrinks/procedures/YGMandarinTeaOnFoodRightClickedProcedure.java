...
import net.mcreator.hongkongdrinks.entity.YGMandarinTeaEntityEntity;
import net.mcreator.hongkongdrinks.HongkongdrinksModElements;

@HongkongdrinksModElements.ModElement.Tag
public class YGMandarinTeaOnFoodRightClickedProcedure extends HongkongdrinksModElements.ModElement {
	public YGMandarinTeaOnFoodRightClickedProcedure(HongkongdrinksModElements instance) {
		super(instance, 52);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((entity.isSneaking()) && (new ItemStack(YGMandarinTeaItem.block, (int) (1))
			...
			if (entity instanceof PlayerEntity)
				((PlayerEntity) entity).inventory.clearMatchingItems(p -> new ItemStack(YGMandarinTeaItem.block, (int) (1)).getItem() == p.getItem(),
						(int) 1);
