...
import net.mcreator.hongkongdrinks.entity.YGMangoJuiceEntityEntity;
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((entity.isSneaking()) && (new ItemStack(YGMangoJuiceItem.block, (int) (1))
			...
			if (((entity.getHorizontalFacing()) == Direction.NORTH)) {
				if (!world.isRemote) {
					Entity entityToSpawn = new YGMangoJuiceEntityEntity.CustomEntity(YGMangoJuiceEntityEntity.entity, world);
